...
export default function Footer() {
    ...
    return (
        <footer className="px-5 lg:py-20 max-w-[1000px] mx-auto">
            <div className="lg:py-10 lg:grid lg:grid-cols-4">
                <div>
                    <img src={visionCodingIcon} className="nav-element mx-auto lg:mx-0" />
                    <NavLink to="/">
                        <div className="nav-element py-2 text-2xl text-center lg:text-left">Vision Coding Academy</div>
                    </NavLink>
                </div>
                <div className="flex flex-col py-10 lg:py-0 text-center lg:text-left">
                ...
                <div className="py-10 lg:py-0 text-center lg:text-left">
                ...
                <div className="lg:pl-32 py-10 lg:py-0 flex flex-col text-center lg:text-left">
