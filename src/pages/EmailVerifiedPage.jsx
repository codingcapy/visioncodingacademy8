    ...
    return(
        <main className="flex-1 ">
            <section className="h-[550px] md:h-[700px] py-10 pt-20 bg-gradient-to-t from-black to-gray-900 text-white">
                <h1 className="timeline-content js--fadeInRight text-4xl md:text-8xl text-center">Email Confirmed</h1>
                <p className="timeline-content js--fadeInRight text-md md:text-2xl pt-5 text-center">Thank you for confirming your email address!</p>
